...
# The bundled launcher loads this script from Python 3.14 on systems where
# Tk's package marker is not visible until after initialization.
catch {package require -exact Tk  8.6.15}

